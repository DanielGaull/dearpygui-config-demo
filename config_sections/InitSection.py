    ...
    def __init__(self, dpg):
        ...
        with dpg.collapsing_header(label="Initialization"):
            ...
            def cb_handle_init_mode_change(sender, init_mode):
                ...
                if init_mode == "Randomize":
                    with dpg.group(horizontal=True, tag="randomize_params",
                        ...
                        dpg.add_combo(tag='randomize_until', items=["until pulse threshold", "until variance threshold",
            ...
            with dpg.group():
                ...
                dpg.add_radio_button(tag='init_mode', items=["Clone from seed", "Clone from seed and mutate",
